...
I was born in Kagoshima (Japan), grew up in Bangkok (Thailand) and studied in London (BSc. in Biological Sciences from [Imperial College London](https://www.imperial.ac.uk/)) and Cambridge (MPhil in Zooology from [University of Cambridge](https://www.cam.ac.uk/)). I am now based in southern Germany at the [Max Planck Institute for Biology](https://www.bio.mpg.de/) in Tübingen, working towards a PhD in Bioinformatics.
